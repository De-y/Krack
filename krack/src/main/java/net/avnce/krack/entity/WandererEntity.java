...
public class WandererEntity extends PathfinderMob {
	public WandererEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(KrackModEntities.WANDERER.get(), world);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(KrackModItems.MONEY.get()));
	}
	...
	public static void init() {
		SpawnPlacements.register(KrackModEntities.WANDERER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
