...
import net.avnce.krack.procedures.LavaarmorHelmetTickEventProcedure;
...
public abstract class LavaArmorItem extends ArmorItem {
	...
	public static class Helmet extends LavaArmorItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "krack:textures/models/armor/armo1_layer_1.png";
		}
	...
	public static class Leggings extends LavaArmorItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "krack:textures/models/armor/armo1_layer_2.png";
		}
	}
